...
ActiveRecord::Schema[7.0].define(version: 2022_07_14_064051) do
  ...
  create_table "users", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.string "pailog_id", default: "", null: false
    ...
    t.index ["pailog_id"], name: "index_users_on_pailog_id", unique: true
